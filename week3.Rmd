...
subtitle: "Learning Diary - Week 3"
author: "Sheng Li"
format:
  html:
    toc: true
...
Finally, I conducted **Principal Component Analysis (PCA)** to reduce the dimensionality of the multispectral data. The results show that **PC1** mainly represents overall brightness, while **PC2** and **PC3** highlight spectral differences between different land cover types. This method reduces data redundancy while preserving key information.
...
-   **Butcher, G. (2016)** *The Role of Remote Sensing in Monitoring the SDGs*. Available at: https://www.un.org/ (Accessed: 17 March 2026).
...
-   **USGS (2020)** *Landsat 8 Collection 2 Level-2 Science Product Guide*. Available at: https://www.usgs.gov/landsat-missions (Accessed: 17 March 2026).
-   **ESA (European Space Agency) (2023)** *Earth Observation and Copernicus Programme*. Available at: https://www.esa.int/ (Accessed: 17 March 2026).
-   **Greater London Authority (GLA) (2023)** *Statistical GIS Boundary Files for London*. Available at: https://data.london.gov.uk/ (Accessed: 17 March 2026).
